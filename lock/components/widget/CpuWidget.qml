...
Rectangle {
    ...
    property real val: (typeof System !== "undefined") ? System.cpuUsage : 0

    ColumnLayout {
        anchors.fill: parent; anchors.margins: 12; spacing: 4
        RowLayout {
            Layout.fillWidth: true
            Text { text: "🖥️  CPU"; color: "#ff006a"; font.pixelSize: 11; font.bold: true }
        ...
        Rectangle {
            ...
            Rectangle {
                height: parent.height; width: parent.width * (val / 100); radius: 2; color: "#ff006a"
